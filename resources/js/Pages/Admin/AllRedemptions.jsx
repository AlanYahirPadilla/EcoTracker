...
export default function AllTickets({ auth, tickets = [] }) {
  ...
  // Datos de ejemplo para probar la visualización
  const mockTickets = [
    {
      id: 1,
      user: { name: "Juan Pérez", email: "juan@example.com" },
      material: { name: "Plástico", points_per_unit: 2 },
      quantity: 5,
      points_earned: 10,
      ticket_number: "TK-001-2023",
      status: "approved",
      date_formatted: "01/04/2023",
      location: "Edificio E, CUCEI",
      comments: "Botellas de plástico limpias",
    },
    {
      id: 2,
      user: { name: "María García", email: "maria@example.com" },
      material: { name: "Papel", points_per_unit: 1 },
      quantity: 6,
      points_earned: 6,
      ticket_number: "TK-002-2023",
      status: "pending",
      date_formatted: "02/04/2023",
      location: "Biblioteca, CUCEI",
      comments: "Hojas de cuaderno y folletos",
    },
    {
      id: 3,
      user: { name: "Carlos Rodríguez", email: "carlos@example.com" },
      material: { name: "Aluminio", points_per_unit: 4 },
      quantity: 2,
      points_earned: 8,
      ticket_number: "TK-003-2023",
      status: "rejected",
      date_formatted: "03/04/2023",
      location: "Cafetería, CUCEI",
      comments: "Latas de refresco",
    },
    {
      id: 4,
      user: { name: "Ana López", email: "ana@example.com" },
      material: { name: "Vidrio", points_per_unit: 3 },
      quantity: 3,
      points_earned: 9,
      ticket_number: "TK-004-2023",
      status: "approved",
      date_formatted: "04/04/2023",
      location: "Laboratorio, CUCEI",
      comments: "Frascos de vidrio",
    },
  ]

  // Usar datos reales si existen, de lo contrario usar datos de ejemplo
  const safeTickets = tickets.length > 0 ? tickets : mockTickets
